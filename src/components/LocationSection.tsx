    ...
    <section id="location" className="py-12 bg-background">
      <div className="section-container">
        ...
        <motion.div 
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          <img alt="Map of Europe highlighting Switzerland" className="w-full" src="/lovable-uploads/1f853a60-f550-4403-a1fa-e09079d86fa2.jpg" />
        </motion.div>

        <motion.p 
          className="text-center text-muted-foreground mt-6 max-w-2xl mx-auto text-base"
