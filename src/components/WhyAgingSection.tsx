...
export const WhyAgingSection = () => {
  return (
    <section id="why-aging" className="py-16 bg-secondary/50 relative section-elegant">
      {/* Decorative gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-secondary/30 to-transparent pointer-events-none" />
      
      <div className="section-container relative z-10">
        <motion.h2 
          className="section-title text-center mb-6 font-sans font-bold text-3xl"
        ...
        <div className="space-y-12">
          ...
          >
            <span className="text-3xl font-bold text-gradient">+41 years</span>
            <p className="text-muted-foreground">of life expectancy gained since 1900.
However...</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <motion.div 
              ...
              viewport={{ once: true, margin: "-50px" }}
            >
              <span className="text-2xl font-bold text-gradient block mb-2">50% of spending</span>
            ...
            <motion.div 
              ...
              viewport={{ once: true, margin: "-50px" }}
            >
              <span className="text-2xl font-bold text-gradient block mb-2">93% prevalence</span>
              <p className="text-muted-foreground leading-relaxed text-sm">
