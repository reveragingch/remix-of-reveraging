...
const teamMembers = [{
  ...
  bio: "Pharma veteran providing Rever with strategic guidance on pharma regulatory, and business. Former CEO of Rejuveron and General Partner at RegenEra Ventures, with experience leading a longevity company through >$75M financing."
}];
const advisors = [{
  image: snyderImg,
